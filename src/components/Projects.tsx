...
const projects = [
  {
    title: "ERP Portal for Law Firm",
    subtitle: "Enterprise Resource Planning",
    description: "A complete ERP solution tailored for a law firm's operations with case tracking and client management.",
    longDescription: "Currently developing a complete ERP solution tailored for a law firm's operations. The portal includes modules for case tracking, client management, document storage, and scheduling. Designed with MUI for responsive UI and built using the MERN stack for full-stack integration.",
  ...
  },
  {
    ...
    description: "Fully responsive travel package booking webpage with search, filter, and secure payment integration.",
    longDescription: "Created a fully responsive design for a travel package booking webpage, enhancing user experience across all devices. Implemented a search and filter feature for 50+ travel packages and integrated a secure payment gateway ensuring smooth transactions for 100+ users.",
    techStack: ["HTML", "CSS", "JavaScript", "Bootstrap"],
    features: [
      "Fully responsive design",
      "Search & filter for 50+ packages",
